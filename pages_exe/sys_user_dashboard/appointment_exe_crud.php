...
if (isset($_POST['submit_btn'])) {
    ...
    $appointment_code= "AP".rand(100,999);
    $appointment_reason = $_POST['appointment_reason'];
    $appointment_status = "Pending";
    $appointment_come = "";
    $appointment_vetcomment = "";
    $appointment_custcreatedby= $_SESSION['system_userid'];
    $appointment_custcreateddate = $currentdate;
    $appointment_vetcreatedby= "";
    $appointment_vetcreateddate = "";

    //Insert Data
    $query = "INSERT INTO appointment (appointment_customerid, appointment_vetid, appointment_schedid, appointment_code, appointment_reason, appointment_status, appointment_come, appointment_vetcomment, appointment_custcreatedby, appointment_custcreateddate, appointment_vetcreatedby, appointment_vetcreateddate) VALUES ('$appointment_customerid', '$appointment_vetid', '$appointment_schedid', '$appointment_code', '$appointment_reason', '$appointment_status', '$appointment_come', '$appointment_vetcomment', '$appointment_custcreatedby', '$appointment_custcreateddate', '$appointment_vetcreatedby', '$appointment_vetcreateddate')";
