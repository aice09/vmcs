...
<ol class="breadcrumb">
  ...
  <li>Stocks Category</li>
</ol>

<h1>Stocks Category</h1>

<button type="button" class="btn btn-success create-new">Add New Stocks Category</button><br><br>
					...
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<div class="form-group">
								...
								<input type="text" class="form-control" placeholder="Name" name="stockcat_name" id="stockcat_name"/>
						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<div class="form-group">
								...
								<select name="stockcat_status" id="stockcat_status" class="form-control">
						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="display: none;">
							<div class="form-group">
								<label for="">ID</label>
								<input type="text" class="form-control" placeholder="ID" name="stockcat_id" id="stockcat_id" value="" />
...
$(document).ready(function() {
    ...
    var dataTable = $('#example').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            url: "pages_exe/sys_user_dashboard/stockscategory_exe_dt.php",
            type: "POST"
        }
    });
    ...
    $('.create-new').click(function() {
        ...
        $("#stockcat_name").val('');
        $("#stockcat_status").val($("#stockcat_status option:first").val());
        $("#stockcat_id").val('');
    ...
    function submitForm() {
        ...
        $.ajax({
            type: 'POST',
            url: 'pages_exe/sys_user_dashboard/stockscategory_exe_crud.php',
            data: data,
    ...
    $(document).on('click', '#update', function(e) {
        ...
        $.ajax({
            ...
            success: function(data, status) {
				...
				//parse json data
				$("#stockcat_name").val(cruddata.stockcat_name);
				$("#stockcat_status").val(cruddata.stockcat_status);
				$("#stockcat_id").val(cruddata.stockcat_id);
